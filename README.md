# 🏠 Үй бағасын болжау моделі (Qyzylorda House price)

Бұл жоба халық санағы мәліметтері негізінде Қызылордадағы жылжымайтын мүліктің орташа құнын болжайтын машиналық оқыту жүйесі болып табылады.

## 📋 Жоба туралы сипаттама
Модель келесі 5 негізгі көрсеткішті талдайды:
* Жер көлемін
* Айлық табысы
* Үйлердің орташа жасы
* Бөлмелер саны
* Үй ауданы 
* Инфрақұрылым сапасы:* Нысан маңындағы әлеуметтік нысандардың (мектеп, саябақ, магазин) қолжетімділігі есепке алынады. Бұл параметр бағаны **15%-ға дейін** өзгертуге қабілетті. 
* Материалдық талдау:* Үйдің материалына (Кирпич, Панель) байланысты жылу оқшаулау және төзімділік коэффиценттері енгізілген. 
* Орталыққа қашықтық:* Географиялық орналасуына байланысты бағаның динамикалық төмендеуі (әр км сайын -2%) есептеледі.
...
* **Plotly** — "Спидометр" стиліндегі визуалды индикаторлар мен графиктер.
